"""
Django settings for purple_thunder_44986 project.
...
ROOT_URLCONF = 'purple_thunder_44986.urls'
...
WSGI_APPLICATION = 'purple_thunder_44986.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_thunder_44986 API",
    "DESCRIPTION": "API documentation for purple_thunder_44986 App",
    "VERSION": "v1",
}
